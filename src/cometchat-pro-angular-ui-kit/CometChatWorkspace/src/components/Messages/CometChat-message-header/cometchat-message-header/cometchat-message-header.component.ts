...
export class CometChatMessageHeaderComponent
  ...
  constructor(public datepipe: DatePipe) {
    ...
    const targetDate = new Date('December 31, 1969 21:00:00'); // Fecha objetivo (31 de diciembre de 1969, 9:00 PM)
    
    // Calcula la diferencia en milisegundos y luego la convierte a segundos
    const timeDifference = currentDate.getTime() - targetDate.getTime();
    this.secondsElapsed = (Math.floor(timeDifference / 1000)-(this.minuto*1)).toString();
  }
